...
const int SONG_LENGTHS[SONG_COUNT] PROGMEM = {2, 7, 30, 24, 26, 11, 64, 57, 54, 82, 32, 76, 68, 68};
const char *const SONG_TITLES[SONG_COUNT] PROGMEM = {"Coin", "1-UP", "Mario_Fanfare", "AXELF", "Hall_of_the_Mountain_King", "Funeral_March", "Zombie_Nation", "Indiana_Jones", "Killing_Me_Softly", "Coffin_Dancers", "The_Good_the_Bad_and_the_Ugly", "Imerial_March", "Inspector_Gadget", "Neon_Genesis_Evangelion"};
const std::array<const int (*)[2], SONG_COUNT> SONGS = {COIN_SONG, UP_SONG, FANFARE_SONG, AXELF_SONG, HALL_SONG, FUNERAL_SONG, ZOMBIE_SONG, INDIE_SONG, KILLING_SONG, COFFIN_SONG, GBU_SONG, IMPERIAL_SONG, GADGET_SONG, EVANGELION_SONG};
